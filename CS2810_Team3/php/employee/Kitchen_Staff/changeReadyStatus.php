...
/*
 * A query update the ready_status field of the customer_orders DB table for when the kitchen staff
 * have prepared the customer's order and want to notify waiters for them to serve the order.
 */
$query = "UPDATE customer_orders SET ready_status = 'true' WHERE order_number = " . $order . " AND br_id = " . $branch . ";";
