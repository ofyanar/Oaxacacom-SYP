 ...
 * kitchen staff works in is accessed through the $_POST super global variable.
 */
$branch = $_POST['branch'];
 ...
 * the customer_orders database table where the ready_status field is 'false'.
 */
$query = "SELECT order_number, table_number, order_time, basket_no FROM customer_orders WHERE br_id = ". $branch." AND ready_status = 'false';";
