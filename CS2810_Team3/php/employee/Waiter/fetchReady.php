...
// The array below is used to store information of a prepared orders on the customer_orders DB table.
$final = array();
 ...
 * the customer_orders database table where the ready_status field is 'true'.
 */
$query = "SELECT order_number, table_number, order_time, basket_no FROM customer_orders WHERE br_id = ". $branch." AND served_status = 'false' AND ready_status = 'true';";
